...
Graph mining and particularly kernel learning methods that use the graph representation
have seen a steady growth in success and proposed approaches during the last decades.
...
Moreover usually the procedure to estimate the resulting model performances is
still computationally demanding for most serious applications.\\
WIP\\
In this study we address these problems by devising a general methodology to
validate graph kernel methods effectively and efficiently.
...
state-of-the-art while always maintaining comparable performances
