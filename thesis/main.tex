...
%
% This study would not have been possible without the participation and help of
% the following people to which I owe my gratitude.
%
%I would like to deeply and sincerely thank my thesis supervisor \textbf{Prof. Alessandro
%Sperduti}, for the opportunity of working on this project, for the invaluable 
%teachings and infinite patience during these months.
%
%I would also like express a special thank you to my thesis co-supervisor \textbf{Dr. Nicol\`o Navarin}
%for the help, advice and constant support throughout the whole project.
%
%Moreover, the for the precious and prompt technical support with the HPC facilities,
%I would like to thank \textbf{Dr. Luca Righi}.
%
