...
python -m scripts/calculate_matrix_allkernels ${dataset} $radius $lambda grams/$dataset/k$1.r$radius.l$lambda.mtx $1"> $HOME/tesi/jobs/${dataset}.$radius.$lambda.$1.gram.job
