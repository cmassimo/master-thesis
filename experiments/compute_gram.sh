...
echo "#!/bin/sh
### Set the job name
#PBS -N THCMASS.r$radius.l$lambda.$dataset.gram
...
python -m script/calculate_matrix_allkernels ${dataset} $radius $lambda $1 $2"> $HOME/tesi/jobs/${dataset}.$radius.$lambda.$1.$2.gram.job
