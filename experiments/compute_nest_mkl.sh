...
python -u $HOME/cluster_bundle/master-thesis/experiments/cv_all_matrices_mkl.py $lambda cvres/${dataset}/mkl/multikernel $seed 4337 grams/${dataset}/mkl/*.svmlight "> $HOME/tesi/jobs/${dataset}.$lambda.nested.job
