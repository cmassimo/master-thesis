...
python $HOME/cluster_bundle/master-thesis/experiments/cv_all_matrices_mkl.py $lambda cvres/${dataset}/mkl/multikernel grams/${dataset}/mkl/* "> $HOME/tesi/jobs/${dataset}.$lambda.nested.job
