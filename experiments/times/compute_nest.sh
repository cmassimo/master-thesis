...
### You MUST speciframs[i]y some number of nodes or Torque will fail to load balance.
...
python $HOME/cluster_bundle/master-thesis/experiments/times/svm_compute_times.py grams/${dataset}/$1/$2 $size times/$dataset/$3"> $HOME/tesi/jobs/${dataset}.times.job

qsub $HOME/tesi/jobs/${dataset}.times.job
