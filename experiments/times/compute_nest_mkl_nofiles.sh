...
python -u $HOME/cluster_bundle/master-thesis/experiments/times/easymkl_compute_times_nofiles.py times/$dataset/$1 $dataset $2 "> $HOME/tesi/jobs/${dataset}.times.mkl.job
