...
python -u ME_cv_all_matrices_hierarchy_mkl.py $lambda cvres/${dataset}/hmkl/multikernel $seed 4337 grams/${dataset}/mkl/*.svmlight "> $HOME/tesi/jobs/${dataset}.$lambda.hmkl.nested.job
